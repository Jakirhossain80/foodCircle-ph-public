...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 w-full container bg-[#f9fafb] dark:bg-gray-900 border-gray-200 dark:border-gray-700 px-4 py-10 flex justify-between items-center z-50 transition-all duration-500">
      {/* Logo and Title */}
